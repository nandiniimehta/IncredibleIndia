                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" style={{ "paddingLeft": "30px", "alignItems": "center" }}>
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src='assets/puducherry4.jpg' class="d-block w-100" alt="..." style={{ "height": "500px", "width": "600px" }} />
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/puducherry3.jpg" class="d-block w-100" alt="..." style={{ "height": "500px", "width": "600px" }} />
                                </div>
                                <div class="carousel-item">
                                    <img src='assets/puducherry2.jpg' class="d-block w-100" alt="..." style={{ "height": "500px", "width": "600px" }} />
                                </div>
                            </div>
