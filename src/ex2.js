...
const MainContent = () => {
    ...
    return (
        ...
        <div style={{ "padding": "1px" }}>
            ...
            {activeContent === 'content2' && <Content2  title={HeritageData[1].title2} desc={HeritageData[1].content2} />}
            {activeContent === 'content3' && <Content3  title={HeritageData[2].title3} desc={HeritageData[2].content3}/>}
